<?php
  ...
  $menuPromo = isset($sub->menuprice) && isset($rowIndex) ? $menuPrice - $data->promodiscount : 0;
?>
...
<tr class="subItem">
  <td style="padding-top:1px !important">
    ...
    <input type="hidden" name="sub[{{ $rowIndex }}][index]" value="sub[{{ $rowIndex }}]" />
    @if($canEdit)
